    ...
    fun onImageGalleryClicked(view: View){
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(
                ...
                ), REQUEST_PEMISSION_READ_EXTERNAL_STORAGE
            )
        }else{
...
// permission not granted initate request
    ActivityCompat.requestPermissions(
        this@MainActivity, arrayOf(
            android.Manifest.permission.WRITE_EXTERNAL_STORAGE), REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE
    )
}else {
//    create an image file name
    ...
    companion object{
        ...
        const val REQUEST_PEMISSION_READ_EXTERNAL_STORAGE = 3
